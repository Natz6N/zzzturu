...
const jidDecode = (jid) => {
    ...
    if (server === 'lid') {
        ...
        const parsed = parseInt(agent);
        domainType = Number.isNaN(parsed) ? WAJIDDomains.WHATSAPP : parsed;
    }
