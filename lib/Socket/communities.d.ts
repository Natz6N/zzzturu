...
export declare const makeCommunitiesSocket: (config: SocketConfig) => {
    ...
    sendMessage: (jid: string, content: import("../Types/index.js").AnyMessageContent, options?: import("../Types/index.js").MiscMessageGenerationOptions) => Promise<import("../Types/index.js").WAMessage>;
    sendButton: (jid: string, content?: any, options?: any) => Promise<import("../Types/index.js").WAMessage>;
    sendCard: (jid: string, options?: any) => Promise<import("../Types/index.js").WAMessage>;
