...
export declare const makeMessagesRecvSocket: (config: SocketConfig) => {
    ...
    sendMessage: (jid: string, content: import("../Types/index.js").AnyMessageContent, options?: import("../Types/index.js").MiscMessageGenerationOptions) => Promise<WAMessage>;
    sendButton: (jid: string, content?: any, options?: any) => Promise<WAMessage>;
    sendCard: (jid: string, options?: any) => Promise<WAMessage>;
